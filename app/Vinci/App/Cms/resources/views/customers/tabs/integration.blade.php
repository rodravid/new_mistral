        ...
        <div class="col-xs-12">
            ...
            <div class="btn-group" style="margin-bottom: 20px;">
                <a href="javascript:void(0);" class="btn btn-success"
                   data-form-link
                   data-method="POST"
                   data-confirm-title="Confirmação de exportação"
                   data-confirm-text="Deseja realmente exportar o cliente agora?"
                ...
                <a href="javascript:void(0);" class="btn btn-primary"
                   ...
                   data-confirm-text="Deseja realmente enviar o cliente para a fila de integração?"
                   data-params='{"current-tab":"#customer-integration"}'

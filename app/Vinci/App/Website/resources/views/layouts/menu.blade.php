        ...
        <ul class="menu">
            ...
            <li class="menu-item larger760-right template4">
                ...
                <div class="drop-menu">
                    <div class="division">
                        <ul class="list-sub-menu">
                            <li><a href="/c/tipo-de-vinho/tinto">Tinto</a></li>
                            <li><a href="https://www.vinci.com.br/busca?tipo-de-vinho%5B%5D=Branco+Seco&tipo-de-vinho%5B%5D=Branco+Doce&tipo-de-vinho%5B%5D=Branco+Suave&tipo-de-vinho%5B%5D=Branco+Meio+Seco">Branco</a></li>
                            <li><a href="/c/tipo-de-vinho/rosado">Rosado</a></li>
            ...
            <li class="menu-item larger760-right template7">
                ...
                <div class="drop-menu">
                    ...
                    <div class="division">
                        <div class="featured-wrap">
                            {!! productCardMenu(258, 'Chile', 'template7') !!}
                        </div>
                    </div>
            ...
            <li class="menu-item larger760-right template9">
                ...
                <div class="drop-menu">
                    ...
                    <div class="division">
                        <div class="featured-wrap">
                            {!! productCardMenu(3031, 'Itália', 'template9') !!}
                        </div>
                    </div>
                </div>
            </li>

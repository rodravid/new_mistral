...
@section('body')
    ...
    <tr>
        <td style="font-size:15px;font-family:Arial, verdana, sans-serif;">
            ...
            <p>
                Seu pedido de número <span style="font-size: 15px; color: #11b6f0 !important;"><b>{{ $order->number }}</b></span>
                realizado em nosso site foi transferido para o setor de televendas.
            </p>

            <p>Caso seja necessário entraremos em contato para finalizar a compra.</p>
        </td>
    </tr>

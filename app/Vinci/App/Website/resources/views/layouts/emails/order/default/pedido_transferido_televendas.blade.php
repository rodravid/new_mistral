...
@section('body')
    ...
    O atendimento do seu pedido de Nº. <span style="font-size: 13px; color: #11b6f0 !important;"><b>{{ $order->number }}</b></span> foi transferido para o setor de Televendas.<br /><br />

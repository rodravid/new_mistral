...
<?php $color = '#fd571d'; ?>
@section('header.title', 'PEDIDO EM FATURAMENTO')
...
@section('body')
    ...
    <tr>
        <td style="border: solid 1px #bbcad1; padding: 20px; font-size: 18px;font-family:Arial, verdana, sans-serif;">
            ...
            <b style="color: {{ $color }} !important;">{{ $order->total }}</b> foi recebido em nosso sistema de comércio eletrônico e está em faturamento.
        </td>
    </tr>

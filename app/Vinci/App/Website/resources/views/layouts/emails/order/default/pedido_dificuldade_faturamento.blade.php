...
@section('body')
    ...
    Informamos que referente ao seu pedido nº. <span style="font-size: 13px; color: #14a68f !important;"><b>{{ $order->number }}</b></span> estamos com dificuldades em processar o faturamento.<br /><br />

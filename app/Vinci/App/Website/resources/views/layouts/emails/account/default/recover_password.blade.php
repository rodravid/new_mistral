...
@section('body')
    ...
    <p> De acordo, com sua solicitação <a href="{{ $link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}" style="font-size:13px; color: #11b6f0 !important;">Clique aqui para alterar a sua senha</a>, este link expira em 24 horas. </p>

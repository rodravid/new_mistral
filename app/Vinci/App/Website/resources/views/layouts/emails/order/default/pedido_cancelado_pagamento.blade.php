...
@section('body')
    ...
    O pedido nº <span style="font-size: 13px; color: #14a68f !important;"><b>{{ $order->number }}</b></span> foi cancelado devido ao pagamento não ter sido aprovado ou localizado.

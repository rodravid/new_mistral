...
<div class="row">
	...
	<article class="wrap-content-term-of-use template9">

		<div class="colum-620">
			<p class="title-internal-15 mbottom20">Tire suas dúvidas aqui!</p>
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
					...
					<p>
						...
						produtos que estarão sujeitos à confirmação. A liberação do

						pedido efetuado estará sujeita à confirmação de pagamento.

						No caso de indisponibilidade de um ou mais itens do seu

						pedido, despacharemos somente os produtos disponíveis e seu

						pedido será concluído. Sendo, neste caso, cobrado apenas os

						valores proporcionais do pedido atendido.
					</p>
					<p>
						Atenção: Os produtos vendidos através do site destinam-se

						somente ao consumidor final. No caso de revendas, favor
					...
					<p>
						Aviso importante: Qualquer pedido de compra cuja quantidade

						possa ser caracterizada como revenda fica sujeito ao

						recolhimento de ICMS no posto fiscal da fronteira do Estado de

						destino, e estes valores e eventuais despesas são de total

						responsabilidade do cliente. No caso do estado do Amazonas, o

						pedido de compra está sujeito à fiscalização da Sefaz e taxa de

						armazenagem. Eventuais despesas acrescidas são integralmente

						por conta do cliente.
					</p>
					<p>
						A Vinci trabalha com transportadoras cuidadosamente

						escolhidas, que permitem que nossos vinhos sejam despachados

						em segurança para praticamente qualquer parte do Brasil.

						Eventualmente pode haver problemas no transporte e a Vinci

						não pode se responsabilizar por prejuízos causados. No entanto,

						em todas as ocasiões, por favor entre em contato conosco
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
				<p>
					Para São Paulo Capital o prazo médio é de até 2 dias úteis. As

					entregas são gratuitas em São Paulo Capital e algumas cidades

					da Grande São Paulo (vide abaixo) em pedidos a partir de R$

					200,00.
				</p>

					<p>
						Para Rio de Janeiro Capital o prazo médio é de 3 dias úteis. As

						entregas são gratuitas para o Rio de Janeiro Capital em pedidos
					...
					<p>
						Estas transportadoras trabalham com prazos diferenciados de

						entrega, dependendo da região. Ao digitar seu CEP no carrinho

						de compras você pode consultar o prazo de entrega para sua

						região. O frete contratado é por conta e risco do comprador.
					</p>

					<p>
						Aviso Importante - A previsão de entrega é válida após as
					...
					<p>
						...
						pedido será concluído. Sendo, neste caso, cobrados apenas os
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
<p>
	No carrinho de compras, ao finalizar seu pedido, clique em
	...
	presente e serão indicados quando estiverem nestas condições.
					...
					<p>
						Caso você tenha selecionado um item para presente, mas não

						escolheu nenhuma embalagem, a Vinci enviará este item em

						uma embalagem gratuita para presente.
					</p>
				</div>
			</div>
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
				<p>
					Ao efetuar seu cadastro no site, você cadastra também um

					endereço padrão de entrega. A cada pedido, você pode escolher

					despachar para este endereço padrão ou pode optar por utilizar

					um endereço alternativo de entrega que, depois, ficará

					registrado em seu cadastro. Para alterá-lo, por favor atualize

					seus dados na tela de atualização de cadastro.
				</p>
				</div>
			</div>
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
					<p>
						Nossa loja virtual aceita depósito bancário no banco Itaú, os

						cartões de crédito VISA, MASTERCARD, DINERS e AMEX.
					</p>
					<p>
						Atenção para o meio de pagamento de “depóstio bancário”, que

						estará sujeito a confirmação dos itens do pedido juntamente ao

						nosso estoque, e portanto, as informações bancárias para o

						depósito serão enviadas automaticamente através de um

						segundo e-mail, somente após a confirmação e conferência do

						seu pedido em nosso processo logístico. O primeiro e-mail é

						apenas para confirmar a solicitação de pedido de compra. Por

						favor, aguarde o segundo e-mail com a liberação para o

						pagamento através do depósito.
					</p>
				</div>
			</div>
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
					<p>
						O horário de atendimento para clientes de internet é de segunda
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
					<p>
						O catálogo da Vinci é inovador, repleto de inúmeros rótulos

						premiados e elaborados por alguns dos melhores produtores de

						suas regiões, verdadeiras estrelas do mundo do vinho. A Vinci

						envia para seus clientes diversos informativos e publicações

						especiais com dicas, notícias, notas da imprensa especializada e

						até mesmo verdadeiros guias de diversas regiões produtoras.
					</p>
					<p>
						Para receber nossos catálogos, informativos e publicações

						especiais, ao comprar pelo site, seu cadastro será inscrito nesta

						lista. Caso não tenha feito ainda nenhuma compra e já tenha um
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
					<p>
						A Vinci também envia para seus clientes exclusivas newsletters

						por email com dicas, notícias, promoções especiais, avisos de

						eventos de vinhos e jantares com produtores. Para recebê-la,

						cadastre-se em nosso site e escolha a opção &quot;newsletter&quot;,

						coloque seu nome e e-mail e clique em “cadastrar”. Caso não
					...
					<p>
						...
						jamais cederá seu endereço de email a nenhuma outra empresa.
					</p>
				</div>
			</div>
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
					<p>
						- Facilidade para comprar e receber o pedido em sua casa. <br>

						- Consultar com detalhes todos os vinhos e suas ficha técnicas.<br>

						- Receber nossa newsletter por email com novidades do site,

						eventos de vinho, degustações e jantares com produtores,

						promoções especiais e muito mais.<br>

						- Participar de promoções exclusivas do site.
					</p>
					<p>
						Mesmo se você já for cliente da Vinci através de outros canais,

						você precisa se cadastrar em nosso site para usufruir de todas

						estas vantagens do site.
					</p>
				</div>
			</div>
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
					<p>
						Todas as informações, textos, imagens, logos, downloads e

						outros conteúdos deste site são de propriedade de Vinci

						Importadora e Exportadora de Bebidas Ltda ou de empresas a

						ela associadas, incluindo produtores internacionais de vinho.

						Nenhum destes conteúdos poderá ser copiado, reproduzido,

						distribuído ou utilizado de qualquer forma e em qualquer tipo de

						mídia sem a autorização expressa e por escrito da Vinci.
					</p>

					<p>
						Este material foi desenvolvido por nosso departamento de

						marketing e tem valor comercial e intelectual.
					</p>
					<p>
						...
						utilizados. Consideraremos seu pedido e, caso seja aprovado,

						enviaremos uma autorização por escrito.
					</p>
					<p>
						O uso não autorizado de qualquer material deste site configura

						transgressão à propriedade intelectual e estará sujeito a todas as
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
					<p>
						Os dados pessoais fornecidos por você, como nome, endereço,

						telefone e email, são para uso exclusivo da Vinci e sob nenhuma

						hipótese serão cedidos a qualquer outra empresa.
					</p>
					<p>
						Ao se cadastrar, você pode escolher se deseja ou não receber

						emails especiais da Vinci, com dicas, informações, notícias e

						promoções especiais. A qualquer momento, você pode alterar

						sua opção de receber ou não estes emails e comunicados. Seu

						email ou dados pessoais nunca serão cedidos a nenhuma outra

						empresa. <i>(não há está opção na tela de cadastro - verificar se

						haverá)</i>
					</p>
					<p>
						Nosso site faz uso de cookies e outras tecnologias de internet,

						de forma a tornar sua navegação mais interessante e apresentar

						conteúdos mais adequados a seu gosto pessoal.
					</p>
					<p>
						A compra via internet pelo site da Vinci é muito segura e

						utiliza-se criptografia para garantir a transação de sua compra.

						A Vinci é certificada pelo maior selo de segurança do mundo: a
			...
			<div class="item-acordion">
				...
				<div class="conteudo-accordion">
					...
					<p>
						Nosso departamento corporativo conta com uma equipe de

						vendedores especializados em vinhos, capazes de esclarecer

						todas suas dúvidas e de fornecer um atendimento personalizado

						e de excelente qualidade. Eles também poderão dar diversas

						orientações e sugestões para fazer do vinho uma forma de

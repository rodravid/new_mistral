                    ...
                    <ul class="list-form-register">
                        ...
                        <li>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="email" class="email input-register full" name="email"
                        ...
                        <li>
                            ...
                            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="password" class="email input-register full"
                        ...
                        <li>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    ...
                                    <button type="submit" class="bt-default-full bt-middle template1">Salvar nova senha
                                        <span class="arrow-link">></span></button>
                                </div>
                            </div>

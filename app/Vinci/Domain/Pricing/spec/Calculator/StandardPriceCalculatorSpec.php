...
class StandardPriceCalculatorSpec extends ObjectBehavior
{
    ...
    function it_calculate_price_with_empty_configuration_values(PriceConfiguration $configuration)
    {
        ...
        $configuration->getAliquotIpi()->willReturn(null);
    ...
    function it_calculate_price_with_ipi_taxe(PriceConfiguration $configuration)
    {
        $amount = 150.0;
        ...
        $this->skipDiscounts()->calculate($this->subject)->shouldReturn(651.75);
